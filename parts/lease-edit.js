...
function LeaseEdit({ lease, onChanged }) {
    return <div className='p-1 max-w-4xl md:mx-auto'>
        ...
        <GroupBox titlead='标的房屋'>
            ...
            }} maxLen={8} theClass='self-center sm:self-end basis-full sm:basis-2/7' />
            ...
            }} placeholder='路街、门牌' maxLen={24} theClass='basis-full sm:basis-3/7' />
        </GroupBox>
        <div className='m-1'>
        ...
        <div className='flex flex-row flex-nowrap gap-1 p-1'>
            <Tinumber theNumber={lease.lateDays} caption="滞纳期限" onChanged={d => {
                onChanged({ lateDays: d })
            }} postfix='日' title='期限过后甲方有权收回房屋' maxNumber={99} theClass='basis-1/2 sm:basis-1/3' />
            {(lease.tenancy.sumonth > 12) &&
                <PercentList firstext='免调租金' caption="年调上限" selectedIndex={lease.percentage} onSelectIndex={ti => {
                    onChanged({ percentage: ti })
                }} theClass='basis-1/2 sm:basis-2/3' title="年度租金调整上限" />
            }
        </div>
        ...
        <GroupBox titlead='设施与维护'>
            ...
            <TextEdit shortext={lease.lessor.provides} caption="设施家电" onChanged={d => {
