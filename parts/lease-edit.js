...
function LeaseEdit({ lease, onChanged }) {
    return <div className='bg-slate-600 text-stone-100 p-1'>
        ...
        <div className='p-1 mx-1 flex flex-wrap'>
        ...
        <div className='p-1 mx-1 flex flex-wrap'>
            ...
            }} widthClass='w-72' placeholder='路街、门牌等详细地址' />
        ...
        <div className='p-1 mx-1 flex flex-wrap'>
            ...
            <div className='p-1 m-1 align-text-top'>
        ...
        <div className='p-1 mx-1 flex flex-wrap'>
            ...
            }} placeholder='甲方负责维修的设施' widthClass='w-72 md:w-80 lg:w-96' />
            <Shortext shortext={{ k: "乙方维修：", v: lease.lessee.maint }} onChanged={d => {
                onChanged({ lessee: { ...lease.lessee, maint: d } })
            }} placeholder='乙方负责维修的设施' widthClass='w-72 md:w-80 lg:w-96' />
        </div>
        ...
        <div className='p-1 mx-1 flex flex-wrap'>
            ...
            <div className='flex-auto'>
                <Fieldata fieldata={{ k: "限制行为：", v: lease.forbid, p: '禁养宠物' }} onChanged={d => {
                    onChanged({ forbid: d })
                }} />
            </div>
        </div>
